...
#     for itens_exist, lista_nomes in zip(individuo, ordem_nomes):
#         if itens_exist == 1:
#             valor_item == objetos[lista_nomes["valor"]]
#             peso_item == objetos[lista_nomes["valor"]]
